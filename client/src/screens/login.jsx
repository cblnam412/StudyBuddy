...
export default function Login({ onSuccess }) {
    ...
    const styles = {
        ...
        footer: { marginTop: 12, fontSize: 13, color: "#6b7280", textAlign: "center" },
    };
        ...
        <div style={styles.page}>
            <form style={styles.card} onSubmit={handleSubmit} aria-label="Login form">
                <div>
                    ...
                    <p style={styles.subtitle}>Use your account to continue — light theme</p>
                </div>
                ...
                <div style={styles.form}>
                    ...
                    <div>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", marginTop: 8 }}>
                            <label style={{ fontSize: 13, color: "#374151", display: "flex", alignItems: "center" }}>
                                <input
                ...
                <div style={styles.footer}>Don't have an account? <a href="#" style={styles.smallLink} onClick={(e)=>e.preventDefault()}>Sign up</a></div>
            </form>
        </div>
    );
}
